                ...
                <div className="max-w-md w-full">
                    ...
                    <div className="bg-white rounded-2xl shadow-xl p-8 space-y-6">
                        ...
                        <div className="text-center">
                            <div className="w-16 h-16 bg-gradient-to-br from-indigo-600 to-purple-600 rounded-2xl flex items-center justify-center shadow-lg mx-auto mb-6">
                                <svg
                            ...
                            <div>
                                ...
                                <div className="mt-1 relative">
                                    ...
                                    <TextInput
                                        ...
                                        name="email"
                                        value={data.email}
                                        className="pl-10 block w-full rounded-lg border-gray-300 bg-gray-50 shadow-sm sm:text-sm"
