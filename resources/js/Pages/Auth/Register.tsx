    ...
    return (
        <>
            ...
            <div className="min-h-screen flex">
                ...
                <div className="flex-1 flex flex-col justify-center py-12 px-4 sm:px-6 lg:flex-none lg:px-20 xl:px-24 bg-white">
                    <div className="mx-auto w-full max-w-sm lg:w-96">
                        ...
                        <div className="text-center mb-8">
                            <Link href={route('login')} className="inline-block mb-4">
                ...
                <div className="hidden lg:block relative flex-1 bg-gradient-to-br from-purple-600 via-pink-600 to-red-600">
                    ...
                    <div className="relative h-full flex flex-col justify-center items-center text-white p-12">
                        <div className="max-w-lg text-center">
                            ...
                            <p className="text-xl mb-8 text-purple-100">
                                Create an account and unlock the full power of our content management system.
                            </p>
                            ...
                            <div className="space-y-4 text-left">
                                ...
                                <div className="flex items-start space-x-3">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-purple-100 text-sm">All features available from day one</p>
                                    </div>
                                </div>
                            </div>
                        </div>
